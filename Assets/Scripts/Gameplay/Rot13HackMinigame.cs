...
namespace Gameplay
{
    public class Rot13HackMinigame
    {
        ...
        public Rot13HackMinigame(VisualElement root, string encryptedText, string targetDecryptedText, Action onSuccess)
        {
            _root = root;
            ...
            _highlighter = new UniversalHighlighter(_uiElements.TopAlphabet, _uiElements.BottomAlphabet, UniversalHighlighter.LatinAlphabet, UniversalHighlighter.Rot13Top, UniversalHighlighter.Rot13Bottom);
        ...
        private void OnLetterSelected(char letter)
        {
            ...
            if (index >= 0)
            {
                _highlighter.HighlightAtIndex(index, index);
        ...
        private void OnKeyDown(KeyDownEvent evt)
        {
            ...
            char input = char.ToUpperInvariant(evt.character);
